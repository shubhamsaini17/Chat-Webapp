...
const ChatComponent = () => {
  ...
  const predefinedResponses = {
    ...
    "i have an issue":
      "I'm sorry to hear that. Can you please describe the issue?",
  ...
  const handleSendMessage = (e) => {
    ...
    if (inputValue.trim() || image) {
      ...
      setTimeout(() => {
        ...
        if (image) {
          botResponse =
            "We are checking your issue, and our support team will connect with you regarding this issue. Thank you!";
        } else {
          botResponse =
            predefinedResponses[inputValue.toLowerCase()] ||
  ...
  return (
    <div className="flex h-full">
      <div
        className={`flex flex-col max-w-full border rounded-lg shadow-lg p-4 mr-4 md:mr-auto bg-gray-800 h-6/6 md:h-full dark:bg-gray-800 transition-all duration-300 ease-in-out ${
      ...
      >
        ...
        {showCards && ( // Conditional rendering of the cards
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
            <div className="w-[80%] md:w-full p-2 md:p-4 bg-gray-700 rounded-lg hover:scale-105 transition duration-300">
              ...
              <h3 className="text-white font-bold mb-2 flex">Create</h3>
        ...
        <div className="messages overflow-y-auto flex-grow mb-4 scrollbar-hide">
